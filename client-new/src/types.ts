...
export type FixedPeriod = '1week' | '1month' | '3month' | '6month' | '1year' | 'forever'
...
export interface RouteProps {
  ...
  setCollageGenerationParams: React.Dispatch<React.SetStateAction<Partial<CollageGenerationParams>>>
}
